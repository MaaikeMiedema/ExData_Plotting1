...
##PLOT 2
with (myData, plot(DateTime, Voltage, type="l", xlab=""))
...
##PLOT 4
with (myData, plot(DateTime, Global_reactive_power, type="l", xlab=""))
axis(2, at=1:6, labels =(0:5)/10)
dev.off()

## MESSAGE TO CONSOLE
print("Script has run correctly:")
print(paste("plot4.png written to", as.character(getwd())))
